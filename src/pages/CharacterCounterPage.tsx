  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <ToolsSidebar
          tools={allTools}
          currentTool="/tools/character-counter"
          isCollapsed={isSidebarCollapsed}
          setIsCollapsed={setIsSidebarCollapsed}
        />

        {/* Mobile Floating Sidebar */}
        <ToolsFloatingSidebar tools={allTools} currentTool="/tools/character-counter" />
        ...
        <div className="flex-1 min-w-0">
          <div className="container mx-auto px-4 py-8">
            ...
            <div className={`${isSidebarCollapsed ? 'max-w-6xl' : 'max-w-5xl'} mx-auto`}>
              <CharacterCounter />
              <OtherTools currentTool="/tools/character-counter" />
            </div>
          </div>
      ...
      <FloatingToolsNav currentTool="/tools/character-counter" />
    </div>
  );
};
