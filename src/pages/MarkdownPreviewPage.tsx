  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <ToolsSidebar
          tools={allTools}
          currentTool="/tools/markdown-preview"
          isCollapsed={isSidebarCollapsed}
          setIsCollapsed={setIsSidebarCollapsed}
        />

        {/* Mobile Floating Sidebar */}
        <ToolsFloatingSidebar tools={allTools} currentTool="/tools/markdown-preview" />
      ...
      <FloatingToolsNav currentTool="/tools/markdown-preview" />
    </div>
  );
};
