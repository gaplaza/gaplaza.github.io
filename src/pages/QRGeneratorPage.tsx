  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <ToolsFloatingSidebar tools={allTools} currentTool="/tools/qr-generator" />
        ...
        <div className="flex-1 min-w-0">
          <div className="container mx-auto px-4 py-8">
            ...
            <div className={`${isSidebarCollapsed ? 'max-w-6xl' : 'max-w-5xl'} mx-auto`}>
              <QRGenerator />
              <OtherTools currentTool="/tools/qr-generator" />
            </div>
          </div>
      ...
      <FloatingToolsNav currentTool="/tools/qr-generator" />
    </div>
  );
};
